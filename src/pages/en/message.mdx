...
**Message** is associated with an Action, that is defined in a form of a Signal/Effect pair, registered in an [Object](object) in a [Selo](selo). Actions are invoked by Message passing mechanism.
