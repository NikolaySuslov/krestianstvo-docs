...
**Object** - is a Solid JS Component in form of a Function, but initialised with local properties and actions in form of Signals, registered in a [Selo](selo) component.
[Message](message) passing is used for Object communication.
...
Selo's root component or World is also an Object. It is initalised with more Action [Messages](message) for interacting with Selos and Objects. You can specify the type for Object, forcing it to be a World. Just add the `type` property with `App` value.
