...
Selo in Krestianstvo SDK 4 application architecture is the FRP representation of the Croquet Island / VWF instance. All components inside `<Selo/>` register thier internal properties and actions in form of Signals/Stores in it. These components are [Objects](object).
